...
- Local-only explicit mock mode: `npm run dev`; Express on `127.0.0.1:4700`, Vite on `127.0.0.1:3700` proxies `/api`. No extra public endpoints or browser-only fixtures.
